  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <motion.div
        ...
        className="absolute top-1/3 right-1/3 w-64 h-64 bg-accent/10 rounded-full blur-3xl"
      />
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          Ship faster with pre-built components and enterprise-grade infrastructure.
        </motion.p>
